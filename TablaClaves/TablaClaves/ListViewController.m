...
- (void)viewDidLoad
{
    ...
    for (int i=0; i<25; i++){
        ...
        [self.cells addObject:[NSString stringWithFormat:@"Celda %d", i+1]];
...
{
    static NSString *CellIdentifier = @"Clave";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    detailViewController.cellName = [self.cells objectAtIndex:indexPath.row];
